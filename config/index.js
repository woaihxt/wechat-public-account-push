export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxdf103a0bd93c4123",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "206d824cccdf38d638417cc126d85a44",
  ...
  USERS: [
    {
      ...
      id: "oeBZz6iVkAhx3OZCYDB0m_rqjti4",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "RHhAJPzSou4nC9bufv1eog8Cb_XBIwBzvVQLe2t3X34",
      // 所在省份
      province: "江苏",
      // 所在城市
      city: "南通",
      ...
      festivals: [
        ...
        {"type": "生日", "name": "婷宝", "year": "2002", "date": "02-14"},
      ],
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "oeBZz6itsYwS_h5KL4azttpFVDW8",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
